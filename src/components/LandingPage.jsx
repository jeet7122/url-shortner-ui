...
export default function LandingPage() {
    ...
    return (
        <>
            <title>url-shrink-it - Shorten, Track, and Manage Your Links</title>
            <meta name="description"
                  content="The ultimate free link shortener. Shrink long URLs, get detailed analytics, and manage all your links in one powerful dashboard."/>
            <link rel="canonical" href="https://urlshrinkit.store/" />

            <section
                className="min-h-[90vh] flex items-center justify-center px-5 sm:px-10 lg:px-20 py-20 bg-[#0d0d10] text-white">
